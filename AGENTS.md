...
- **Prefer brief, single line commits.** Commits shouldly concisely describe the change only. No co-authoring statements, session IDs, or footers except for `BREAKING CHANGE:` when explicitly requested.
